...
* [Summary](#Summary)
  ...
  * Design Requirements 
    * Interface Context
    *  Detailed Interface Components - Context
* [Configuration](#Configuration) 
   *  Configuration Assumptions 
   *  Configuration Requirements
      *  Origin 
* [Origin ServiceNow File to DXC ServiceNow Integration Process Overview](#TheOriginUserRecordReceivingFile) 
   * The Origin User Record Receiving File 
   * MID File Transfer / SNOW Import Set Process
   * Business Service Integration
   * Create or Update Origin People Record in ServiceNow
   * Origin ServiceNow File to DXC ServiceNow Users Integration Process Rules 
   * Import Set table and Transform Map 
     * Origin 
  * Matching Key –Origin ServiceNow File to DXC ServiceNow 
* [Exception Handling](#DataIssue)
   * Data Issue 
   * Connectivity Issue
...
* **<u> Configuration Requirements**</u>
...
```
<a name="ORIGIN ServiceNow File to DXC ServiceNow Integration Process Overview"></a>

### **<u>ORIGIN ServiceNow File to DXC ServiceNow Integration Process Overview</u>**

* **<u>The ORIGIN User Record Receiving File**</u>
...
* **<u>MID File Transfer / SNOW Import Set Process**</u>
...
* **<u>Business Service Integration**</u>
...
* **<u>Create or Update ORIGIN People Record in ServiceNow**</u>
...
•	The correlation / matching logic to be used against the User ID field in SNOW.
  ...
  **<u>ORIGIN ServiceNow File to DXC ServiceNow Users Integration Process Rules**</u>
...
* **<u>Import Set table and Transform Map**</u>
...
* **<u>Matching Key –ORIGIN ServiceNow File to DXC ServiceNow**</u>
